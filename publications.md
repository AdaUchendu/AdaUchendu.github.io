...
1. [Using Topological Data Analysis to Characterize the Layers of Language Models Before and After Word Substitution Attacks]() <br>
Adam Tang, Shreya Subramanian, Catherine Liu, Kimberly Lopez, Leif Zinn-Brooks, Alexia Schultz, **Adaku Uchendu** <br>
ACL 2026 Workshop on Customizable NLP (CustomNLP4U)

2. [BLUFF: Benchmarking the Detection of False and Synthetic Content across 58 Low-Resource Languages](https://arxiv.org/abs/2603.00634) <br>
...
KDD Datasets and Benchmarks Track, South Korea, August 2026

3. [Position: Breaking the Dual Curse of Multilingual AI Requires Socio-Technical Guardrails, Not Post-Hoc Alignment]() <br>
...
4. [The Shape of Vulnerability: How Adversarial Perturbations Reshape the Topology of Language Model Latent Spaces]() <br>
...
5. [Synthetic Text Detection in the Age of Large Language Models: Watermark vs. Automatic Detection]() <br>
**Adaku Uchendu** <br>
ACL 2026 Industry Track, San Diego, California, July 2026

6. [DIA-HARM: Harmful Content Detection Robustness Across 50 English Dialects](https://arxiv.org/abs/2604.05318) <br>
Jason Lucas, *Matt Murtagh-White, *Ali Lawati, Uchendu Uchendu, **Adaku Uchendu**, Dongwon Lee  <br>
ACL 2026, San Diego, California, July 2026

7. [Topological Data Analysis Applications in Natural Language Processing: A Survey](https://arxiv.org/pdf/2411.10298) <br>
**Adaku Uchendu**, Thai Le <br>
KDD Explorations, June 2026

8. [Signature vs. Substance: Evaluating the Balance of Adversarial Resistance and Linguistic Quality in Watermarking Large Language Models](https://arxiv.org/pdf/2511.13722) <br>
...
9. [Beyond speculation: Measuring the growing presence of LLM-generated texts in multilingual disinformation](https://arxiv.org/abs/2503.23242) <br>
Dominik Macko, Aashish Anantha Ramakrishnan, Jason Samuel Lucas, Robert Moro, Ivan Srba, **Adaku Uchendu**, Dongwon Lee <br>
IEEE Computer, 2026

10. [Masks and Mimicry: Strategic Obfuscation and Impersonation Attacks on Authorship Verification]()<br>
...
11. [PlagBench: Exploring the Duality of Large Language Models in Plagiarism Generation and Detection](https://arxiv.org/pdf/2406.16288v1) <br>
...
12. [Beemo: Benchmark of Expert-edited Machine-generated Outputs](https://arxiv.org/pdf/2411.04032) <br>
Ekaterina Artemova, Jason Lucas, Saranya Venkatraman, Jooyoung Lee, Sergei Tilga, **Adaku Uchendu**, Vladislav Mikhailov <br>
NAACL 2025, Albuquerque, New Mexico, April 2025 

13. [Authorship Obfuscation in Multilingual Machine-Generated Text Detection](https://arxiv.org/pdf/2401.07867.pdf) <br>
...
14. [TOPFORMER: Topology-Aware Authorship Attribution of Deepfake Texts with Diverse Writing Styles](https://arxiv.org/pdf/2309.12934.pdf) <br>
...
15. [A Ship of Theseus: Curious Cases of Paraphrasing in LLM-Generated Texts](https://arxiv.org/pdf/2311.08374.pdf) <br>
...
16. [GPT-who: An Information Density-based Machine-Generated Text Detector](https://arxiv.org/pdf/2310.06202.pdf) <br>
Saranya Venkatraman, **Adaku Uchendu**, Dongwon Lee <br>
NAACL-Findings 2024, Mexico City, Mexico, June 2024

17. [MULTITuDE: Large-Scale Multilingual Machine-Generated Text Detection Benchmark](https://aclanthology.org/2023.emnlp-main.616.pdf) <br>
...
18. [HANSEN: Human and AI Spoken Text Benchmark for Authorship Analysis](https://aclanthology.org/2023.findings-emnlp.916.pdf) <br>
...
19. [Fighting Fire with Fire: The Dual Role of LLMs in Crafting and Detecting Elusive Disinformation](https://aclanthology.org/2023.emnlp-main.883.pdf) <br>
Jason Lucas, **Adaku Uchendu**, Michiharu Yamashita, Jooyoung Lee, Shaurya Rohatgi, Dongwon Lee <br>
EMNLP 2023, Singapore, December 2023

20. [Does Human Collaboration Enhance the Accuracy of Identifying LLM-Generated Deepfake Texts?](https://arxiv.org/abs/2304.01002) <br>
...
21. [Attribution and Obfuscation of Neural Text Authorship: A Data Mining Perspective](https://dl.acm.org/doi/pdf/10.1145/3606274.3606276?casa_token=mH78K7icCqgAAAAA:HQcHMZcQn11pVU9XTKK0O5RcArqpuRTMXdK_89oTUSPrr5irabhnDeUFoOVZAJabVBh4bjC7nYPF9g) <br>
**Adaku Uchendu**, Thai Le, Dongwon Lee <br>
SIGKDD Explorations, Vol. 25(1), June 2023 [[arXiv version](https://arxiv.org/pdf/2210.10488.pdf)]

22. [Tutorials at The Web Conference 2023](https://dl.acm.org/doi/abs/10.1145/3543873.3587713) <br>
Fionda, V., et al., **Adaku Uchendu**, Thai Le, Dongwon Lee, et al. <br>
The ACM Web Conference (WWW), Austin, TX, April 2023 (Tutorial)

23. [Robustness of Bayesian Neural Networks to White-Box Adversarial Attacks](https://arxiv.org/abs/2111.08591) <br>
...
24. [TURINGBENCH: A Benchmark Environment for Turing Test in the Age of Neural Text Generation](https://arxiv.org/abs/2109.13296) <br>
...
25. [Authorship Attribution for Neural Text Generation](https://www.aclweb.org/anthology/2020.emnlp-main.673.pdf) <br>
...
26. [Characterizing Man-made vs. Machine-made Chatbot Dialogs](https://truthandtrustonline.com/wp-content/uploads/2019/09/paper_27.pdf) <br>
**Adaku Uchendu**, Jeffrey Cao, Qiaozhi Wang, Bo Luo, Dongwon Lee. <br> 
In Conf. on Truth and Trust Online (TTO), London, UK, October 2019.

27. [A Reverse Turing Test for Detecting Machine-Made Texts](https://pike.psu.edu/publications/websci19-rtt.pdf) <br> 
